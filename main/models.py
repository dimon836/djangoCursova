...
class PositionEm(models.Model):
    ...
    id_rate = models.ForeignKey('ProductionRate', on_delete=models.CASCADE)
...
class OilChange(models.Model):
    ...
    id_machine = models.ForeignKey('WorkingMachine', on_delete=models.CASCADE)
...
class Employer(models.Model):
    ...
    id_status = models.ForeignKey('HistoryPromotions', on_delete=models.CASCADE)
    id_position = models.ForeignKey('PositionEm', on_delete=models.CASCADE)
...
class Trip(models.Model):
    ...
    id_talon = models.ForeignKey('Coupon', on_delete=models.CASCADE)
    id_employer = models.ForeignKey('Employer', on_delete=models.CASCADE)
